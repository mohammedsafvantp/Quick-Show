  ...
  const dashboardCard =[
    {title:"Total Bookings", value:dashboardData.totalBooking || "0", icon:ChartLineIcon},
        {title:"Total Revenue",  value:currency + dashboardData.totalRevenue || "0", icon:CircleDollarSignIcon},
            {title:"Active Shows", value:dashboardData.activeShow || "0", icon:PlayCircleIcon},
  ...
  return !loading ? (
    <>
     ...
     {dashboardData.activeShow.map((show)=>(
      <div key={show._id}   className='w-55 rounded-lg overflow-lg overflow-hidden h-full pb-3 bg-primary/10 border border-primary/20 hover:-translate-y-1 transistion duration-300'>
